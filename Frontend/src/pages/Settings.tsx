  ...
  return (
    <div className="p-8">
      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">AI Usage Statistics</h2>

          <div className="grid grid-cols-2 gap-6">
            <div className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
              <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Requests Today</div>
              <div className="text-2xl font-bold text-gray-900 dark:text-white">
                {health.aiUsage.requestsToday.toLocaleString()}
              </div>
            </div>
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-200 dark:border-gray-700">
              ...
              <div className="text-2xl font-bold text-gray-900 dark:text-white">
                {health.aiUsage.tokensUsed.toLocaleString()}
              </div>
            </div>
          </div>
        </div>
